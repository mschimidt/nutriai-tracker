...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-emerald-600 text-white hover:bg-emerald-700 shadow-lg shadow-emerald-200/20",
    secondary: "bg-orange-500 text-white hover:bg-orange-600 shadow-lg shadow-orange-200/20",
